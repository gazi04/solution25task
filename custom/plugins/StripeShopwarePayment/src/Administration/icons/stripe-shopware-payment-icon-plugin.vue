<template>
  <!-- eslint-disable max-len vue/max-len vue/no-static-inline-styles -->
  <svg
      width="256"
      height="256"
      viewBox="0 0 256 256"
  ...
  <!-- eslint-enable max-len vue/max-len vue/no-static-inline-styles -->
</template>

<script>
export default {
  name: 'stripe-shopware-payment-icon-plugin',
};
</script>
