...
class PaymentIntentHandlerService
{
    /**
    ...
    public function pay(
        ...
        $orderTransaction = $this->stripeOrderTransactionService->getOrderTransaction($orderTransactionId, [], $context);
        $customer = $this->stripeCustomerService->getCustomerForOrderTransaction($orderTransaction, $context);
        ...
        $paymentIntentConfig->setReturnUrl($returnUrl);
